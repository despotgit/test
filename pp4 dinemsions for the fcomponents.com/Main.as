package  {
	...
	public class Main extends MovieClip
	{
		...
		private function init_docks():void
		{
			...
			//setting for dock5 x manje za 67, y manje za 52
			dock5.set_docking_point(495,422);
			dock5.set_docked_point(505,432);
			dock5.set_unloading_boat_rotation(45);
			dock5.set_unloaded_boat_rotation(225);
			dock5.visible=false;
			
			//setting for dock6 x manje za 67?, y manje za 52
			dock6.set_docking_point(538,432);
			dock6.set_docked_point(548,390);	 
